...
int main(int, char**)
{
    PaleRenderer::CWindowOpenGL Window("PaleEngine v0.1");
...
//int main()
//{
//    PaleRenderer::CWindowOpenGL Window(1920, 1080);
//    auto pWindow = Window.fetchWindowPtr();
...
//       
//    }
//    int test = glCreateShader(GL_VERTEX_SHADER);
//
