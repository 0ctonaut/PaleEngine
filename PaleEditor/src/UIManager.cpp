...
namespace PaleUI
{
	CUIManager::CUIManager()
	{
		...
		m_ViewportPanel = new CViewportPanel(&EventViewportResize);
	}
	CUIManager::~CUIManager()
	{
	...
	void CUIManager::OnUISetup(GLFWwindow* vWindow)
	{
		// --- imgui setup --- 
		IMGUI_CHECKVERSION();
		ImGui::CreateContext();
	...
	void CUIManager::OnUIBeginFrame()
	{
    ...
    void CUIManager::useDockSpace(bool* p_open)
    {
        // READ THIS !!!
